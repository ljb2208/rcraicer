...
#include <memory>
#include "../../../track_builder/imageviewer.h"
...
QT_MOC_LITERAL(4, 26, 1) // "y"
    ...
    "ImageViewer\0mousePress\0\0x\0y"
};
...
void ImageViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mousePress((*reinterpret_cast< const int(*)>(_a[1])),(*reinterpret_cast< const int(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ImageViewer::*)(const int , const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageViewer::mousePress)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ImageViewer::mousePress(const int _t1, const int _t2)
{
