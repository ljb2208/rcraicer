...
#include <stddef.h>
#include "rcraicer_msgs/msg/detail/chassis_command__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  rcraicer_msgs__msg__ChassisCommand__init(message_memory);
}

void ChassisCommand__rosidl_typesupport_introspection_c__ChassisCommand_fini_function(void * message_memory)
{
  rcraicer_msgs__msg__ChassisCommand__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ChassisCommand__rosidl_typesupport_introspection_c__ChassisCommand_message_member_array[4] = {
  {
    "header",  // name
    ...
    offsetof(rcraicer_msgs__msg__ChassisCommand, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs__msg__ChassisCommand, throttle),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs__msg__ChassisCommand, steer),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs__msg__ChassisCommand, sender),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ChassisCommand__rosidl_typesupport_introspection_c__ChassisCommand_message_members = {
  ...
  4,  // number of fields
  sizeof(rcraicer_msgs__msg__ChassisCommand),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcraicer_msgs, msg, ChassisCommand)() {
