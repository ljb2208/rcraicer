...
{
  new (message_memory) rcraicer_msgs::msg::Encoder(_init);
}

void Encoder_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rcraicer_msgs::msg::Encoder *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Encoder_message_member_array[5] = {
  {
    ...
    offsetof(rcraicer_msgs::msg::Encoder, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs::msg::Encoder, left_rear),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs::msg::Encoder, left_front),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs::msg::Encoder, right_front),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs::msg::Encoder, right_rear),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Encoder_message_members = {
  ...
  5,  // number of fields
  sizeof(rcraicer_msgs::msg::Encoder),
...
get_message_type_support_handle<rcraicer_msgs::msg::Encoder>()
{
  return &::rcraicer_msgs::msg::rosidl_typesupport_introspection_cpp::Encoder_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rcraicer_msgs, msg, Encoder)() {
  return &::rcraicer_msgs::msg::rosidl_typesupport_introspection_cpp::Encoder_message_type_support_handle;
}
