...
{
  new (message_memory) rcraicer_msgs::msg::PathIntegralTiming(_init);
}

void PathIntegralTiming_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rcraicer_msgs::msg::PathIntegralTiming *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PathIntegralTiming_message_member_array[4] = {
  {
    ...
    offsetof(rcraicer_msgs::msg::PathIntegralTiming, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs::msg::PathIntegralTiming, average_time_between_poses),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs::msg::PathIntegralTiming, average_optimization_cycle_time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs::msg::PathIntegralTiming, average_sleep_time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PathIntegralTiming_message_members = {
  ...
  4,  // number of fields
  sizeof(rcraicer_msgs::msg::PathIntegralTiming),
...
get_message_type_support_handle<rcraicer_msgs::msg::PathIntegralTiming>()
{
  return &::rcraicer_msgs::msg::rosidl_typesupport_introspection_cpp::PathIntegralTiming_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rcraicer_msgs, msg, PathIntegralTiming)() {
  return &::rcraicer_msgs::msg::rosidl_typesupport_introspection_cpp::PathIntegralTiming_message_type_support_handle;
}
