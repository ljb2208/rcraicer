...
#include <stddef.h>
#include "rcraicer_msgs/msg/detail/path_integral_status__rosidl_typesupport_introspection_c.h"
...
#include "rcraicer_msgs/msg/detail/path_integral_status__struct.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  rcraicer_msgs__msg__PathIntegralStatus__init(message_memory);
}

void PathIntegralStatus__rosidl_typesupport_introspection_c__PathIntegralStatus_fini_function(void * message_memory)
{
  rcraicer_msgs__msg__PathIntegralStatus__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember PathIntegralStatus__rosidl_typesupport_introspection_c__PathIntegralStatus_message_member_array[3] = {
  {
    ...
    offsetof(rcraicer_msgs__msg__PathIntegralStatus, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs__msg__PathIntegralStatus, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs__msg__PathIntegralStatus, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers PathIntegralStatus__rosidl_typesupport_introspection_c__PathIntegralStatus_message_members = {
  ...
  3,  // number of fields
  sizeof(rcraicer_msgs__msg__PathIntegralStatus),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcraicer_msgs, msg, PathIntegralStatus)() {
