...
#ifndef RCRAICER_MSGS__MSG__DETAIL__PATH_INTEGRAL_PARAMS__STRUCT_HPP_
#define RCRAICER_MSGS__MSG__DETAIL__PATH_INTEGRAL_PARAMS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rcraicer_msgs__msg__PathIntegralParams __attribute__((deprecated))
#else
# define DEPRECATED__rcraicer_msgs__msg__PathIntegralParams __declspec(deprecated)
#endif
...
struct PathIntegralParams_
{
  ...
  using ConstRawPtr =
    const rcraicer_msgs::msg::PathIntegralParams_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rcraicer_msgs::msg::PathIntegralParams_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rcraicer_msgs::msg::PathIntegralParams_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rcraicer_msgs::msg::PathIntegralParams_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rcraicer_msgs::msg::PathIntegralParams_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rcraicer_msgs::msg::PathIntegralParams_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rcraicer_msgs::msg::PathIntegralParams_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rcraicer_msgs::msg::PathIntegralParams_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rcraicer_msgs__msg__PathIntegralParams
    std::shared_ptr<rcraicer_msgs::msg::PathIntegralParams_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rcraicer_msgs__msg__PathIntegralParams
    std::shared_ptr<rcraicer_msgs::msg::PathIntegralParams_<ContainerAllocator> const>
...
using PathIntegralParams =
  rcraicer_msgs::msg::PathIntegralParams_<std::allocator<void>>;
...
#endif  // RCRAICER_MSGS__MSG__DETAIL__PATH_INTEGRAL_PARAMS__STRUCT_HPP_
