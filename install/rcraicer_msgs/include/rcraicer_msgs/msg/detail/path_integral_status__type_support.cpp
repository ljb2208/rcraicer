...
{
  new (message_memory) rcraicer_msgs::msg::PathIntegralStatus(_init);
}

void PathIntegralStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rcraicer_msgs::msg::PathIntegralStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PathIntegralStatus_message_member_array[3] = {
  {
    ...
    offsetof(rcraicer_msgs::msg::PathIntegralStatus, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs::msg::PathIntegralStatus, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs::msg::PathIntegralStatus, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PathIntegralStatus_message_members = {
  ...
  3,  // number of fields
  sizeof(rcraicer_msgs::msg::PathIntegralStatus),
...
get_message_type_support_handle<rcraicer_msgs::msg::PathIntegralStatus>()
{
  return &::rcraicer_msgs::msg::rosidl_typesupport_introspection_cpp::PathIntegralStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rcraicer_msgs, msg, PathIntegralStatus)() {
  return &::rcraicer_msgs::msg::rosidl_typesupport_introspection_cpp::PathIntegralStatus_message_type_support_handle;
}
