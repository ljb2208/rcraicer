...
#include <stddef.h>
#include "rcraicer_msgs/msg/detail/path_integral_stats__rosidl_typesupport_introspection_c.h"
...
#include "rcraicer_msgs/msg/detail/path_integral_stats__struct.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  rcraicer_msgs__msg__PathIntegralStats__init(message_memory);
}

void PathIntegralStats__rosidl_typesupport_introspection_c__PathIntegralStats_fini_function(void * message_memory)
{
  rcraicer_msgs__msg__PathIntegralStats__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember PathIntegralStats__rosidl_typesupport_introspection_c__PathIntegralStats_message_member_array[4] = {
  {
    ...
    offsetof(rcraicer_msgs__msg__PathIntegralStats, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs__msg__PathIntegralStats, tag),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs__msg__PathIntegralStats, params),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs__msg__PathIntegralStats, stats),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers PathIntegralStats__rosidl_typesupport_introspection_c__PathIntegralStats_message_members = {
  ...
  4,  // number of fields
  sizeof(rcraicer_msgs__msg__PathIntegralStats),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcraicer_msgs, msg, PathIntegralStats)() {
