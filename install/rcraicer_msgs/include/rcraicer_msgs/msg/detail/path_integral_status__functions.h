...
#ifndef RCRAICER_MSGS__MSG__DETAIL__PATH_INTEGRAL_STATUS__FUNCTIONS_H_
#define RCRAICER_MSGS__MSG__DETAIL__PATH_INTEGRAL_STATUS__FUNCTIONS_H_
 ...
 * calls
 * rcraicer_msgs__msg__PathIntegralStatus__init().
...
/**
 * It calls
 * rcraicer_msgs__msg__PathIntegralStatus__fini()
 ...
 * rcraicer_msgs__msg__PathIntegralStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rcraicer_msgs__msg__PathIntegralStatus__Sequence__fini()
 * on the array,
...
#endif  // RCRAICER_MSGS__MSG__DETAIL__PATH_INTEGRAL_STATUS__FUNCTIONS_H_
