...
#include <stddef.h>
#include "rcraicer_msgs/msg/detail/path_integral_timing__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  rcraicer_msgs__msg__PathIntegralTiming__init(message_memory);
}

void PathIntegralTiming__rosidl_typesupport_introspection_c__PathIntegralTiming_fini_function(void * message_memory)
{
  rcraicer_msgs__msg__PathIntegralTiming__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember PathIntegralTiming__rosidl_typesupport_introspection_c__PathIntegralTiming_message_member_array[4] = {
  {
    ...
    offsetof(rcraicer_msgs__msg__PathIntegralTiming, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs__msg__PathIntegralTiming, average_time_between_poses),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs__msg__PathIntegralTiming, average_optimization_cycle_time),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rcraicer_msgs__msg__PathIntegralTiming, average_sleep_time),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers PathIntegralTiming__rosidl_typesupport_introspection_c__PathIntegralTiming_message_members = {
  ...
  4,  // number of fields
  sizeof(rcraicer_msgs__msg__PathIntegralTiming),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rcraicer_msgs, msg, PathIntegralTiming)() {
