#include "../include/rcraicer/gps_node.h"
...
{    
    ...
    ubxProto = new UbxProtocol((rclcpp::Node::SharedPtr) this, msgDebug.as_bool(), portPath.as_string(), baudRate.as_int(), isBase.as_bool());
