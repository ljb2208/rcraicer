                                    ...
                                    gotInitialPose_(false)
{
 ...
 // temporary variables to retrieve parameters
    ...
    imuDt_ = getsetParameter<double>("Imudt", 1.0/200.0);    
    ...
    fixedInitialPose = getsetParameter<bool>("FixedInitialPose",  false);
    ...
    usingOdom_ = getsetParameter<bool>("UseOdom", false);
...
void StateEstimator::completeSetup()
{
    ...
    gpsSub_ = this->create_subscription<sensor_msgs::msg::NavSatFix>("gps", 300, std::bind(&StateEstimator::GpsCallback, this, std::placeholders::_1));
    ...
    odomSub_ = this->create_subscription<nav_msgs::msg::Odometry>("wheel_odom", 300, std::bind(&StateEstimator::WheelOdomCallback, this, std::placeholders::_1));

    std::thread optimizer(&StateEstimator::GpsHelper,this);
}
...
void StateEstimator::GpsHelper()
{
    ...
    while (rclcpp::ok())
    {
      ...
      else
      {
        ...
        rclcpp::Time tsIMU = imuOptQ_.back()->header.stamp;
        ...
        rclcpp::Time tsGps = gpsOptQ_.front()->header.stamp;
        ...
        rclcpp::Time tsOdom = odomOptQ_.front()->header.stamp;
